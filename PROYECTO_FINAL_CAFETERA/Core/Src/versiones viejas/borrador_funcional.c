...
void fsm_update(void) {
    ...
    static delay_nb_t delay_eeprom;
        ...
        switch (subestado_off) {
            case 0:
                ...
                if (boton1_presionado()) {
                    ...
                    delay_nb_start(&delay_eeprom, 1000);
                    subestado_off = 1;
                }
            ...
            // === CAMINO A ESTADO_MENU_PRINCIPAL ===
            case 1:
                if (delay_nb_expired(&delay_eeprom)) {
                    eeprom_load_config();
                    lcd_clear();
                    lcd_put_cur(0, 0);
                    lcd_send_string("Konnichiwa !!");
                    delay_nb_start(&delay_eeprom, 1500);
                    subestado_off = 2;
                }
                break;
